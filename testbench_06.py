...
def workspace():
	try:
		print(f'\nEsse arquivo de teste foi feito para testar a entidade geométrica Segmento de Reta')
		...
		rect = LineSegment(name, Point('p1',pointData[0][0],pointData[0][1]), Point('p2', pointData[1][0],pointData[1][1]), '#000')
		print(rect.model())
