from package.maths.Shapes import Triangule
...
def workspace():
	try:
		...
		triang = Triangule(name, Point('p1',pointData[0][0],pointData[0][1]), Point('p2', pointData[1][0],pointData[1][1]), Point('p3',pointData[2][0],pointData[2][1]), '#000')
		print(triang.model())
